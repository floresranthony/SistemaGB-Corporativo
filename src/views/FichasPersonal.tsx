...
export function FichasPersonal() {
  ...
  const downloadExcelTemplate = () => {
    const headers = [
      ...
      "lugar_especifico_trabajo", "regimen_laboral_nombre", "asignacion_familiar", "vencimiento_asignacion_familiar", "sueldo_basico", "bono", "bono_secundario",
    ...
    const exampleRow1 = [
      ...
      "Almacén Central", "Régimen General", "SI", "18-12-2035", "1200.00", "150.00", "50.00",
    ...
    const exampleRow2 = [
      ...
      "Operaciones Apurímac", "Régimen General", "NO", "", "2500.00", "0.00", "0.00",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      step="0.01"
                      value={personaForm.bono_secundario || ""}
                      onChange={(e) => {
                        const val = e.target.value;
                  ...
                  {!!personaForm.asignacion_familiar && (
                    <div className="animate-fadeIn">
                      ...
                      <input
                        ...
                        onChange={(e) => setPersonaForm({ ...personaForm, vencimiento_asignacion_familiar: e.target.value })}
                        className="w-full p-2.5 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-100 focus:outline-none"
                      />
                    </div>
                  )}
